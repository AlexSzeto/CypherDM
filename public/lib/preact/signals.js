/* esm.sh - @preact/signals@1.2.2 */
import { Component as z, options as V, isValidElement as B } from 'preact'
import { useMemo as k, useRef as G, useEffect as D } from 'preact/hooks'
...
function b() {
  if (v > 1) v--
    ...
    for (var t, i = !1; p !== void 0;) {
      var n = p
      for (p = void 0, $++; n !== void 0;) {
        var r = n.o
        if (((n.o = void 0), (n.f &= -3), !(8 & n.f) && O(n)))
          try {
            n.c()
          } catch (e) {
            i || ((t = e), (i = !0))
...
Object.defineProperty(u.prototype, 'value', {
  ...
  set: function (t) {
    if (t !== this.v) {
      if ($ > 100) throw new Error('Cycle detected')
      ;((this.v = t), this.i++, S++, v++)
      try {
...
;(h.prototype = new u()).h = function () {
  ...
  if (((this.g = S), (this.f |= 1), this.i > 0 && !O(this)))
    return ((this.f &= -2), !0)
  var t = o
  try {
    ;(j(this), (o = this))
...
function U(t) {
  ...
  ;((t.x = void 0), (t.s = void 0), A(t))
}
function q(t) {
  if (o !== this) throw new Error('Out-of-order effect')
  ;(P(this), (o = t), (this.f &= -2), 8 & this.f && U(this), b())
}
function l(t) {
  ;((this.x = t),
    (this.u = void 0),
...
l.prototype.S = function () {
  if (1 & this.f) throw new Error('Cycle detected')
  ;((this.f |= 1), (this.f &= -9), A(this), j(this), v++)
  var t = o
  return ((o = this), q.bind(this, t))
}
...
function J(t) {
  ...
  var e = k(function () {
    ...
    return (
      (i.__$u.c = function () {
        var s
        !B(e.peek()) && ((s = i.base) == null ? void 0 : s.nodeType) === 3
          ? (i.base.data = e.peek())
          : ((i.__$f |= 1), i.setState({}))
      }),
      w(function () {
  ...
  if (typeof i.type == 'string' && (n = i.__e)) {
    ...
    if (r) {
      ...
      if (f)
        for (var s in f) {
          var a = f[s]
          a !== void 0 && !(s in r) && (a.d(), (f[s] = void 0))
        }
      else n.U = f = {}
      for (var _ in r) {
        var y = f[_],
          C = r[_]
        y === void 0 ? ((y = F(n, _, C, e)), (f[_] = y)) : y.o(C, e)
      }
    }
  }
  t(i)
...
function F(t, i, n, r) {
  var e = i in t && t.ownerSVGElement === void 0,
    f = g(n)
  return {
    o: function (s, a) {
      ;((f.value = s), (r = a))
    ...
    d: c(function () {
      ...
      r[i] !== s &&
        ((r[i] = s),
        e ? (t[i] = s) : s ? t.setAttribute(i, s) : t.removeAttribute(i))
    }),
  }
}
...
z.prototype.shouldComponentUpdate = function (t, i) {
  var n = this.__$u
