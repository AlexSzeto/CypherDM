...
function Q(e, t) {
  function n(o) {
    var u = this.props.ref,
      a = u == o.ref
    return (
      !a && u && (u.call ? u(null) : (u.current = null)),
      t ? !t(this.props, o) || !a : b(this.props, o)
    )
  }
  function r(o) {
...
;(((C.prototype = new f()).isPureReactComponent = !0),
  ...
  ((h.prototype = new f()).__c = function (e, t) {
    ...
    var l = function () {
      if (!--r.__u) {
        if (r.state.__a) {
          var s = r.state.__a
          r.__v.__k[0] = A(s, s.__c.__P, s.__c.__O)
        }
        var g
  ...
  (h.prototype.render = function (e, t) {
    if (this.__b) {
      if (this.__v.__k) {
        ...
        this.__v.__k[0] = T(this.__b, n, (r.__O = r.__P))
      }
      this.__b = null
    }
    var o = t.__a && c(d, null, e.fallback)
    return (o && (o.__u &= -33), [c(d, null, t.__a ? null : e.children), o])
  }))
...
function ue(e) {
  ...
  ;((t.componentWillUnmount = function () {
    ...
    v(c(oe, { context: t.context }, e.__v), t.l))
}
function ae(e, t) {
  var n = c(ue, { __v: e, i: t })
  return ((n.containerInfo = t), n)
}
;(((p.prototype = new f()).__a = function (e) {
  var t = this,
    n = F(t.__v),
    r = t.o.get(e)
  return (
  ...
  (p.prototype.componentDidUpdate = p.prototype.componentDidMount =
    function () {
      var e = this
...
var V =
  ...
  le = /^on(Ani|Tra|Tou|BeforeInp|Compo)/,
  se = /[A-Z0-9]/g,
...
function pe(e, t, n) {
  return (W(e, t), typeof n == 'function' && n(), e ? e.__c : null)
}
  ...
  ;(typeof e.type == 'string' &&
    (function (t) {
      ...
      for (var u in n) {
        var a = n[u]
        if (!(
          (u === 'value' && 'defaultValue' in n && a == null) ||
          (_e && u === 'children' && r === 'noscript') ||
          u === 'class' ||
          u === 'className'
        )) {
          var l = u.toLowerCase()
          ;(u === 'defaultValue' && 'value' in n && n.value == null
            ? (u = 'value')
            : u === 'download' && a === !0
              ? (a = '')
              : l === 'ondoubleclick'
                ...
                : l !== 'onchange' ||
                  ...
                  ? l === 'onfocus'
                    ...
                    : l === 'onblur'
                      ...
                      : le.test(u)
                        ? (u = l)
                        : r.indexOf('-') === -1 && ie.test(u)
                          ? (u = u.replace(se, '-$&').toLowerCase())
                          : a === null && (a = void 0)
                  : (l = u = 'oninput'),
            l === 'oninput' && o[(u = l)] && (u = 'oninputCapture'),
            (o[u] = a))
        }
      }
      ;(r == 'select' &&
        ...
        (o.value = _(n.children).forEach(function (s) {
          s.props.selected = o.value.indexOf(s.props.value) != -1
        })),
        r == 'select' &&
          o.defaultValue != null &&
          (o.value = _(n.children).forEach(function (s) {
            s.props.selected = o.multiple
              ? o.defaultValue.indexOf(s.props.value) != -1
              : o.defaultValue == s.props.value
          })),
        n.class && !n.className
          ? ((o.class = n.class), Object.defineProperty(o, 'className', me))
...
function Ee(e) {
  return m(e) ? z.apply(null, arguments) : e
}
function Se(e) {
...
export {
  ...
  h as Suspense,
  p as SuspenseList,
  ye as __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
  Ee as cloneElement,
  We as createContext,
  $e as createElement,
  be as createFactory,
  ...
  Se as unmountComponentAtNode,
  Ne as unstable_batchedUpdates,
  xe as useDeferredValue,
  Pe as useInsertionEffect,
  Ue as useSyncExternalStore,
  Oe as useTransition,
  Le as version,
}
//# sourceMappingURL=compat.bundle.mjs.map
