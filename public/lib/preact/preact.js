...
function re(e, _, t) {
  ...
  if (
    (arguments.length > 2 &&
      (l.children = arguments.length > 3 ? D.call(arguments, 2) : t),
...
function I(e) {
  ;((!e.__d && (e.__d = !0) && C.push(e) && !A.__r++) ||
    j !== a.debounceRendering) &&
    ((j = a.debounceRendering) || K)(A)
}
function A() {
...
function se(e, _, t, i) {
  ...
  if (i > (c != null && (131072 & c.__u) == 0 ? 1 : 0))
    for (; l >= 0 || s < _.length;) {
      if (l >= 0) {
        if ((c = _[l]) && (131072 & c.__u) == 0 && o == c.key && r === c.type)
          return l
        l--
      }
      if (s < _.length) {
        if ((c = _[s]) && (131072 & c.__u) == 0 && o == c.key && r === c.type)
          return s
        s++
      }
    }
...
function z(e, _, t) {
  _[0] === '-'
    ? e.setProperty(_, t ?? '')
    : (e[_] =
        t == null ? '' : typeof t != 'number' || oe.test(_) ? t : t + 'px')
}
        ...
        if (
          ...
          !n.__e &&
            ((n.shouldComponentUpdate != null &&
              n.shouldComponentUpdate(d, n.__s, x) === !1) ||
              _.__v === t.__v))
        ) {
          for (
...
function ce(e, _, t) {
  var i, o, r, l
  ;(a.__ && a.__(e, _),
    (o = (i = typeof t == 'function') ? null : (t && t.__k) || _.__k),
    (r = []),
    (l = []),
    B(
      _,
      (e = ((!i && t) || _).__k = re(H, null, [e])),
      o || E,
      E,
      _.ownerSVGElement !== void 0,
      !i && t ? [t] : o ? null : _.firstChild ? D.call(_.childNodes) : null,
      r,
      !i && t ? t : o ? o.__e : _.firstChild,
      i,
      l,
    ),
    te(r, e, l))
...
function de(e, _, t) {
  ...
  for (r in (e.type && e.type.defaultProps && (l = e.type.defaultProps), _))
    r == 'key'
      ...
      : r == 'ref'
        ? (o = _[r])
        : (s[r] = _[r] === void 0 && l !== void 0 ? l[r] : _[r])
  return (
    arguments.length > 2 &&
      (s.children = arguments.length > 3 ? D.call(arguments, 2) : t),
    S(e.type, s, i || e.key, o || e.ref, null)
  )
}
function he(e, _) {
  var t = {
...
export {
  ...
  re as h,
  pe as hydrate,
  ne as isValidElement,
  a as options,
  ce as render,
  le as toChildArray,
}
//# sourceMappingURL=preact.bundle.mjs.map
