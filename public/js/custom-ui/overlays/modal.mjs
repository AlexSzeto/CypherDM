...
/**
 * Helper to imperatively show a video modal.
 * @param {string} videoUrl - URL of the video to play
 */
export function createVideoModal(videoUrl) {
  const container = document.createElement('div')
  document.body.appendChild(container)
  ...
  render(html`<${ImperativeVideoModal} />`, container)
}
