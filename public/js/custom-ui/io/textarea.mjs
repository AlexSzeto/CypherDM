 ...
 * @param {Object} [props.buttonProps] - Optional icon button rendered top-right inside the textarea
 ...
 *
 * @example
 * // Textarea with action button
 * <Textarea label="Self Profile" buttonProps=${{ icon: 'captions', title: 'Generate', onClick: handleGenerate }} />
 */
export class Textarea extends Component {
  ...
  render() {
    ...
    const textareaStyle = buttonProps
